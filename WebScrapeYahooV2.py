...
def Company_Information():
    Ticker=input('Input ticker of company:')
    Information_Type=0
    while Information_Type==0:
        ...
        if Information_Type==str(2) or Information_Type=='Analysis':
            Information=Analysis()
        if Information_Type==str(3) or Information_Type=='Historical Data':
            Information=Historical_Data()
        if Information_Type==str(4) or Information_Type=='Statistics':
...
def Analysis():
    analysis_link = 'https://finance.yahoo.com/quote/BABA/analysis?p={ticker}'
    Table_Names=[]
    Table_headers = []
    Rows_list = []
    Table_clean = []
...
def Historical_Data():
    history_link = 'https://finance.yahoo.com/quote/BABA/history?p={Ticker}'
...
def Statistics():
    statistics_link = 'https://finance.yahoo.com/quote/BABA/key-statistics?p={ticker}'
    Table_Names=[]
    Table_headers = []
    Rows_list = []
    Table_clean = []
